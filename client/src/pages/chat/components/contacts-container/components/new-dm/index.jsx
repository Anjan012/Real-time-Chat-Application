...
const NewDM = () => {
    ...
    // we need state to store the search contacts
        ...
        <>
            ...
            <Dialog open={openNewContactModal} onOpenChange={setOpenNewContactModal}>
                <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col ">
                    ...
                    <div>
                        <Input placeholder="Search for a contact..." className="rounded-lg p-6 bg-[#2c2e3b] border-none "
                    ...
                    {
                        searchedContacts.length <= 0 && <div className="flex-1 md:bg-[#1c1d25] md:flex flex-col justify-center items-center duration-1000 transition-all mt-5">
